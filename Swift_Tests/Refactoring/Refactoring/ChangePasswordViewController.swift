...
class ChangePasswordViewController: UIViewController {
    ...
    private func validateInputs() -> Bool {
        ...
        if newPasswordTextField.text != confirmPasswordTextField.text {
            showAlert(message: "The new password and the confirmation password don't match. Please try again") {
                [weak self] _ in
                self?.resetNewPasswords()
            }
            return false
    ...
    private func setUpWaitingAppearance() {
        ...
        NSLayoutConstraint.activate([blurView.heightAnchor.constraint(equalTo: view.heightAnchor),
                                     blurView.widthAnchor.constraint(equalTo: view.widthAnchor), activityIndicator.centerXAnchor.constraint(equalTo: view.centerXAnchor), activityIndicator.centerYAnchor.constraint(equalTo: view.centerYAnchor)])
